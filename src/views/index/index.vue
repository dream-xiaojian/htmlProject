        ...
        <header id="homeTabs" ref="header">
            <div class=" py-2 bg-white relative w-full flex border-b-2 items-center px-2"> 
                ...
                <span class="flex-none">
                    <svg xmlns="http://www.w3.org/2000/svg" width="1.6em" height="1.6em" viewBox="0 0 24 24"><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m21 21l-4.343-4.343m0 0A8 8 0 1 0 5.343 5.343a8 8 0 0 0 11.314 11.314"/></svg>
                </span>
            </div>
        </header>
