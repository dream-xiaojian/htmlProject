<template lang="">
    <div class=" w-screen h-screen bg-slate-100">
        ...
        <header id="homeTabs" ref="header">
            <div class=" py-2 bg-white relative w-full flex border-b-2 items-center px-2"> 
                ...
                <div  class="grow flex items-center justify-center gap-6"> 
                    <!-- <span class="text-gray-500 hover:text-black hover:font-bold" @touchstart="changeMode(0, 'findFollowPage')" >关注</span> -->
                    <span :class="{ 'text-black font-bold': defaultHover }" class=" text-gray-500  hover:text-black hover:font-bold" @touchstart="changeMode(3, 'findHomePage')">欢迎来到文章分享平台</span>
