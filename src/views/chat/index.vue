    ...
    <div class="w-full h-full p-2">
        <div>
            ...
            <div class="mt-3 overflow-y-auto pb-4 overflow-auto" style="height: calc(100vh - 60px - 60px)">
                <div @click="goChat" class=" flex justify-between items-center mt-2 text-slate-600 text-base px-6 py-2 w-full mx-auto bg-white rounded-xl shadow-lg" 
                    v-for="(item, index) in HistoryChatTable" :key="index">
...
/**
 * 历史对话表 id tittle time chatlist[具体里面的每一句对话]
 * HistoryChatTable
 */

const HistoryChatTable = ref([
    {
        id: 1,
        tittle: '未命名对话',
        isOpen: false,
...
const goChat = () => {
    router.push({ name: "chatDetail", query: { id: 1 } });
}
